...
export default function PopulationStandardDeviationCalculator(){
    ...
    return(
        <>
            <NavBar2 pagename="Population Standard Deviation Calculator"/>
            <AddLayout>
                    ...
                    <Formik
                        ...
                        onSubmit = {(values)=>{
                            ...
                            const postData = async () => {
                                ...
                                if(msg === "success"){
                                    setValue(responseData.message.standardDeviation)
