                            ...
                            <form onSubmit={handleSubmit}>
                                <Box sx={{  minHeight: 300, display:'flex', flexDirection:'column' }}>
                                    <Grid container={true} >
                                        ...
                                        <Grid item={true} xs={5} ><Box>First Term</Box></Grid>
                                        <Grid item={true} xs={7}>
                                            <CustomForm
                                                type="text"
                                                name="first_term"
                                        ...
                                        <Grid item xs={5}><label style={{ marginRight: 10 }}>Common Difference</label></Grid>
                                        <Grid item xs={7}>
                                        <CustomForm
                                            type="text"
                                        ...
                                        <Grid item xs={5}><label style={{ marginRight: 10 }}>No# of Observations</label></Grid>
                                        <Grid item xs={7}>
                                            <CustomForm
                                                type="text"
