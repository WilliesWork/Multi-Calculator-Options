...
export default function DecimalToHexadecimalCalculator(){
    ...
    return(
        <>
        <NavBar2 pagename="Decimal To Hexadecimal Calculator"/>
        <AddLayout>
                        ...
                        onSubmit = {(values)=>{
                            ...
                            const postData = async () => {
                                ...
                                if(msg === "success"){
                                    ...
                                    console.log(responseData.message.valueInHexadecimal)
                                }
                            }
                            postData()
                        }}>
